...
public class Order implements Serializable {
    ...
    public Order(int orderNo, Beverage orderBev, int quantity, OrderStatus status, Member orderMem) {
        this.orderNo = orderNo;
        this.orderBev = orderBev;
        this.quantity = quantity;
        this.totalPrice = orderBev.getPrice() * quantity; // 주문 전체 금액 (주문음료 금액 * 주문수량
        this.status = status;
